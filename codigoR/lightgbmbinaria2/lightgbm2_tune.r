...
datasets_lightgbm = function( parchivos1, parchivos2 )
{
  ...
  dataset1_clase  <- as.numeric(  dataset1[ ,get(kclase_nomcampo)] %in% kclase_valor_positivo_train  ) 
  ...
  #dejo la clase en {0,1}  clase  binaria2
  dataset2_clase  <- as.numeric(  dataset2[ ,get(kclase_nomcampo)] %in% kclase_valor_positivo_test  )
