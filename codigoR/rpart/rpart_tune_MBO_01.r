...
#exp-1300
#source( "~/cloud/cloud1/codigoR/rpart/rpart_tune_MBO_01.r" )
...
karchivo_trabajo      <-  "rpart_tune_MBO_01.RDATA"


#Parametros salida
karchivo_salida       <-  "hyperparameter_GLOBAL.txt"
karchivo_imagen       <-  "rpart_tune_MBO_01_evolucion.jpg"

#estos valores se graban en el archivo de salida
kexperimento          <-  1300
kclase                <-  "ternaria"
kprograma             <-  "rpart_tune_MBO_01.r"
kalgoritmo            <-  "rpart"
kbusqueda             <-  "MBO"
...
modelo_rpart_ganancia_MBO = function( x = list( pmaxdepth, pminbucket, pminsplit, pcp )  )
{
