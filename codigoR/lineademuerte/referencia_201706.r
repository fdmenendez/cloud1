#Este programa calcula que ganancia hubiera dado la prediccion de lineademuerte en 201706
...
karchivos_generacion  <-  "201704_hist.txt,201703_hist.txt,201702_hist.txt,201701_hist.txt,201612_hist.txt,201611_hist.txt,201610_hist.txt,201609_hist.txt"
karchivos_aplicacion  <-  "201706_hist.txt"  
...
#------------------------------------------------------------------------------
#para 201706 SI HAY clase, y SI puedo calcular la ganancia
...
#  [350]:  valid's binary_logloss:0.0242276        valid's ganancia:5.418e+06
#  5.418e+06