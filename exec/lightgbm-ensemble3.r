...
save(sal.xg,file="modelos_xg2017_full")
...
save(sal.xg.ant,file="modelos_xg2016_full")
...
nuevo_abril_full<- dataset_validacion %>% select(
  mpasivos_margen,
...
saveRDS(nuevo_abril,file=paste0(directory.datasets,"nuevo_abril_full.rds"))
